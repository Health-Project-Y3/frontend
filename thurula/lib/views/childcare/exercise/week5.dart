...
class _Week5State extends State<Week5> {
  ...
  late Future<List<Checklists>> _week5;

  @override
  void initState() {
    super.initState();
    checklist1 = ChecklistService.getChecklist('64cbb52cf2083327515c7058');
    _week5 = ChecklistService.fetchWeek2();
  }
                ...
                ExpansionPanelList(
                  expansionCallback: (panelIndex, isExpanded) {
                    setState(() {
                      ...
                      expanded[int.parse(week5[panelIndex].panel ?? "0")] =
                          isExpanded;
                    });
                  },
