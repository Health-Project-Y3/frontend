...
class _Week6State extends State<Week6> {
  ...
  late Future<List<Checklists>> _week6;

  @override
  void initState() {
    super.initState();
    checklist1 = ChecklistService.getChecklist('64cbb52cf2083327515c7058');
    _week6 = ChecklistService.fetchWeek2();
  }
                ...
                ExpansionPanelList(
                  expansionCallback: (panelIndex, isExpanded) {
                    setState(() {
                      ...
                      expanded[int.parse(week6[panelIndex].panel ?? "0")] =
                          isExpanded;
                    });
                  },
