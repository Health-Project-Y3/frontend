...
class Week14View extends StatelessWidget {
  const Week14View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Second Trimester - Week 14",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'Your baby-to-be can now use facial muscles to grimace and smile. Boy or girl? This week, fully developed genitals make their grand entrance. Note, however, that they still may be hard to detect on an ultrasound.',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/14.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
