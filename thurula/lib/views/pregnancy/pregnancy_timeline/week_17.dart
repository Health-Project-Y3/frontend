...
class Week17View extends StatelessWidget {
  const Week17View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Second Trimester - Week 17",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'Your little one is practicing sucking and swallowing as he gets ready for the real thing.Baby\'s sense of hearing is making big strides this week. His ears are close to being fully formed and he\'s starting to be able to hear your voice.',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/17.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
