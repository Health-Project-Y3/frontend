...
class Week19View extends StatelessWidget {
  const Week19View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Second Trimester - Week 19",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'Your baby\'s lungs are developing, with the main airways (called bronchioles) beginning to form this week.You may be able to feel baby move for the first time this week, but don\'t panic if you don\'t. You will soon!',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/19.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
