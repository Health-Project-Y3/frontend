...
class Week23View extends StatelessWidget {
  const Week23View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Second Trimester - Week 23",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'Baby\'s skin is a bit saggy (but won\'t be for long as fat begins forming) and has a pinkish-red hue (this is true in all skin colors), thanks to the developing veins and arteries right underneath.',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/23.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
