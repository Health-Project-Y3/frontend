...
class Week30View extends StatelessWidget {
  const Week30View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Third Trimester - Week 30",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'The surface of your baby’s brain begins to wrinkle-the wrinkles are called convolutions-so that it can hold more brain cells.Your baby’s hands are now fully formed and fingernails are growing. In ultrasounds, you may catch baby grabbing a foot.',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/30.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
