...
class Week34View extends StatelessWidget {
  const Week34View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("Third Trimester - Week 34",
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const Expanded(
                              child: Text(
                                'As your baby grows, you may be able to see body parts like little hands and feet through your belly! Your baby closes those cute eyes when she snoozes and opens them when she’s awake, helping your little one settle into a sleep schedule.',
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey,
                                  height: 1.5,
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/34.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
