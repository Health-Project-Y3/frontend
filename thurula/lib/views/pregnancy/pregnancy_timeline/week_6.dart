...
class Week6View extends StatelessWidget {
  const Week6View({super.key});
      ...
      body: SingleChildScrollView(
        ...
        children: [
          const Center(
            ...
            child: Text("First Trimester - Week 6",
                style: TextStyle(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                    'assets/images/fetus-size/6.jpg',
                                    height: 100),
                              ),
                            ),
                          ],
                ...
                child: const Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10),
                      Text(
                        "For some, week six brings one of the most dreaded pregnancy symptoms: morning sickness. Your heightened sense of smell can further exacerbate this queasiness, which sets the stage for food cravings and aversions. Morning sickness might stick around until the second trimester, so it's best to find ways to cope now",
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey,
                          height: 1.5,
